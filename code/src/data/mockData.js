...
export const MOCK_SUPPORT_SESSIONS = [
  { id: 1, storeId: 1, storeName: "패션스토어 루미", status: "IN_PROGRESS", title: "린넨 셔츠 사이즈 교환", orderId: 101, createdAt: "2026-03-06 14:30", lastMessageAt: "2026-04-08 10:15", orderInfo: "린넨 셔츠 (ORD-2026-001)", orderProductName: "린넨 셔츠", customerName: "서재철", source: "manual" },
  { id: 2, storeId: 1, storeName: "패션스토어 루미", status: "RESOLVED", title: "데님 팬츠 색상 문의", orderId: 102, createdAt: "2026-03-11 10:00", lastMessageAt: "2026-04-09 10:00", orderInfo: "데님 팬츠 (ORD-2026-003)", orderProductName: "데님 팬츠", customerName: "서재철", source: "manual" },
  { id: 3, storeId: 1, storeName: "패션스토어 루미", status: "IN_PROGRESS", title: "코튼 카디건 올 풀림 문제", orderId: 104, createdAt: "2026-03-20 16:45", lastMessageAt: "2026-04-07 09:00", orderInfo: "코튼 카디건 (ORD-2026-010)", orderProductName: "코튼 카디건", customerName: "서재철", source: "manual" },
  { id: 4, storeId: 1, storeName: "패션스토어 루미", status: "RESOLVED", title: "스트라이프 티셔츠 배송 지연", orderId: 105, createdAt: "2026-03-24 11:00", lastMessageAt: "2026-03-25 09:30", orderInfo: "스트라이프 티셔츠 (ORD-2026-013)", orderProductName: "스트라이프 티셔츠", customerName: "서재철", source: "manual" },
  { id: 5, storeId: 2, storeName: "맛있는 빵집", status: "RESOLVED", title: "소금빵 알레르기 성분 확인", orderId: 202, createdAt: "2026-03-13 14:00", lastMessageAt: "2026-03-13 15:30", orderInfo: "소금빵 6개입 (ORD-2026-006)", orderProductName: "소금빵 6개입", customerName: "서재철", source: "manual" },
  { id: 6, storeId: 2, storeName: "맛있는 빵집", status: "IN_PROGRESS", title: "딸기 케이크 배송 파손", orderId: 204, createdAt: "2026-03-25 10:00", lastMessageAt: "2026-04-06 16:00", orderInfo: "딸기 생크림 케이크 (ORD-2026-015)", orderProductName: "딸기 생크림 케이크", customerName: "서재철", source: "manual" },
  { id: 7, storeId: 3, storeName: "테크존 전자", status: "IN_PROGRESS", title: "무선 이어폰 블루투스 끊김", orderId: 301, createdAt: "2026-03-10 16:00", lastMessageAt: "2026-04-08 16:00", orderInfo: "무선 이어폰 (ORD-2026-004)", orderProductName: "무선 이어폰", customerName: "서재철", source: "manual" },
  { id: 8, storeId: 3, storeName: "테크존 전자", status: "RESOLVED", title: "USB-C 허브 호환성 문의", orderId: 302, createdAt: "2026-03-17 11:00", lastMessageAt: "2026-03-17 13:00", orderInfo: "USB-C 허브 (ORD-2026-009)", orderProductName: "USB-C 허브", customerName: "서재철", source: "manual" },
  { id: 9, storeId: 3, storeName: "테크존 전자", status: "RESOLVED", title: "키보드 키캡 파손 교환", orderId: 303, createdAt: "2026-03-24 15:00", lastMessageAt: "2026-03-26 10:00", orderInfo: "기계식 키보드 (ORD-2026-014)", orderProductName: "기계식 키보드", customerName: "서재철", source: "manual" },
  { id: 10, storeId: 4, storeName: "그린라이프 마트", status: "IN_PROGRESS", title: "친환경 세제 성분 문의", orderId: 402, createdAt: "2026-03-21 14:00", lastMessageAt: "2026-04-05 10:00", orderInfo: "친환경 세제 리필 (ORD-2026-012)", orderProductName: "친환경 세제 리필", customerName: "서재철", source: "manual" },
  { id: 11, storeId: 5, storeName: "북카페 서랍", status: "IN_PROGRESS", title: "텀블러 보온 성능 문의", orderId: 503, createdAt: "2026-04-09 08:00", lastMessageAt: "2026-04-09 08:00", orderInfo: "텀블러 350ml (ORD-2026-030)", orderProductName: "텀블러 350ml", customerName: "서재철", source: "manual" },
];

export const MOCK_SUPPORT_MESSAGES_BY_SESSION_ID = {
  1: [
    { id: 1, supportSessionId: 1, sender: "customer", content: "안녕하세요, 린넨 셔츠 M사이즈로 주문했는데 L로 교환 가능한가요?", time: "2026-03-06 14:30" },
    { id: 2, supportSessionId: 1, sender: "operator", content: "안녕하세요! 네, 교환 가능합니다. 택배 회수 접수 도와드릴까요?", time: "2026-03-06 15:00" },
    { id: 3, supportSessionId: 1, sender: "customer", content: "네 부탁드립니다!", time: "2026-03-06 15:05" },
    { id: 4, supportSessionId: 1, sender: "operator", content: "접수 완료되었습니다. 내일 중으로 택배 기사님이 방문하실 예정이에요.", time: "2026-04-08 10:15" },
  ],
  2: [
    { id: 1, supportSessionId: 2, sender: "customer", content: "데님 팬츠 실물 색상이 사진이랑 차이 있나요?", time: "2026-03-11 10:00" },
    { id: 2, supportSessionId: 2, sender: "operator", content: "약간의 차이가 있을 수 있으나 모니터 설정에 따른 차이입니다. 실물은 조금 더 진한 인디고 톤이에요.", time: "2026-04-09 10:00" },
  ],
  3: [
    { id: 1, supportSessionId: 3, sender: "customer", content: "코튼 카디건 한 번 입었는데 올이 풀리기 시작했어요.", time: "2026-03-20 16:45" },
    { id: 2, supportSessionId: 3, sender: "operator", content: "사진 첨부해주시면 확인 후 교환/환불 안내드리겠습니다.", time: "2026-03-20 17:30" },
    { id: 3, supportSessionId: 3, sender: "customer", content: "사진 보내드립니다. 소매 부분이 많이 풀렸어요.", time: "2026-03-21 10:00" },
    { id: 4, supportSessionId: 3, sender: "operator", content: "확인했습니다. 불량으로 판단되어 무료 교환 처리 도와드리겠습니다.", time: "2026-04-07 09:00" },
  ],
  4: [
    { id: 1, supportSessionId: 4, sender: "customer", content: "3일 전 주문했는데 아직 발송 안 된 것 같아요.", time: "2026-03-24 11:00" },
    { id: 2, supportSessionId: 4, sender: "operator", content: "확인해보니 물량 폭주로 하루 지연되었습니다. 오늘 중 발송될 예정이에요. 죄송합니다!", time: "2026-03-24 14:00" },
    { id: 3, supportSessionId: 4, sender: "customer", content: "알겠습니다, 감사합니다.", time: "2026-03-25 09:30" },
  ],
  5: [
    { id: 1, supportSessionId: 5, sender: "customer", content: "소금빵에 견과류 성분이 들어가나요? 알레르기가 있어서요.", time: "2026-03-13 14:00" },
    { id: 2, supportSessionId: 5, sender: "operator", content: "소금빵에는 견과류가 들어가지 않습니다. 다만 같은 공장에서 견과류 제품을 생산하고 있어 미량 포함 가능성은 있습니다.", time: "2026-03-13 15:30" },
  ],
  6: [
    { id: 1, supportSessionId: 6, sender: "customer", content: "딸기 케이크 받았는데 배송 중 파손이 있었어요. 사진 보내드립니다.", time: "2026-03-25 10:00" },
    { id: 2, supportSessionId: 6, sender: "operator", content: "정말 죄송합니다. 확인 후 재발송 또는 환불 처리 안내드리겠습니다.", time: "2026-03-25 11:00" },
    { id: 3, supportSessionId: 6, sender: "customer", content: "재발송 부탁드립니다.", time: "2026-03-25 11:30" },
    { id: 4, supportSessionId: 6, sender: "operator", content: "내일 오전 중 재발송 진행하겠습니다.", time: "2026-04-06 16:00" },
  ],
  7: [
    { id: 1, supportSessionId: 7, sender: "customer", content: "이어폰 블루투스 연결이 자꾸 끊겨요. 불량인 것 같은데 확인 부탁드립니다.", time: "2026-03-10 16:00" },
    { id: 2, supportSessionId: 7, sender: "operator", content: "펌웨어 업데이트를 먼저 시도해보시겠어요? 설정 > 기기정보 > 업데이트에서 가능합니다.", time: "2026-03-10 17:00" },
    { id: 3, supportSessionId: 7, sender: "customer", content: "업데이트 해봤는데 여전히 끊깁니다.", time: "2026-04-08 16:00" },
  ],
  8: [
    { id: 1, supportSessionId: 8, sender: "customer", content: "이 허브가 맥북 M3 호환 되나요?", time: "2026-03-17 11:00" },
    { id: 2, supportSessionId: 8, sender: "operator", content: "네, M1/M2/M3 전 모델 호환됩니다!", time: "2026-03-17 13:00" },
  ],
  9: [
    { id: 1, supportSessionId: 9, sender: "customer", content: "키보드 수령했는데 스페이스바 키캡이 깨져있습니다.", time: "2026-03-24 15:00" },
    { id: 2, supportSessionId: 9, sender: "operator", content: "배송 과정 파손으로 보입니다. 키캡만 별도 발송해드리겠습니다.", time: "2026-03-24 16:00" },
    { id: 3, supportSessionId: 9, sender: "customer", content: "감사합니다.", time: "2026-03-26 10:00" },
  ],
  10: [
    { id: 1, supportSessionId: 10, sender: "customer", content: "세제 성분표를 확인하고 싶습니다. 아이가 있어서 안전한지 궁금해요.", time: "2026-03-21 14:00" },
    { id: 2, supportSessionId: 10, sender: "operator", content: "성분표 이미지 첨부해드립니다. 모든 성분이 EWG 1등급입니다.", time: "2026-03-21 15:00" },
    { id: 3, supportSessionId: 10, sender: "customer", content: "감사합니다. 그런데 피부 테스트 인증도 있나요?", time: "2026-04-05 10:00" },
  ],
  11: [
    { id: 1, supportSessionId: 11, sender: "customer", content: "텀블러 보온이 몇 시간 정도 유지되나요?", time: "2026-04-09 08:00" },
  ],
};

export const MOCK_INQUIRY_POSTS = [
  { id: 1, storeId: 1, storeName: "패션스토어 루미", status: "RESOLVED", title: "오버핏 후드 재입고 문의", orderId: 103, content: "오버핏 후드 블랙 L사이즈 재입고 예정 있나요?", isSecret: false, createdAt: "2026-03-16 09:30", lastMessageAt: "2026-03-16 14:00", customerName: "서재철" },
  { id: 2, storeId: 1, storeName: "패션스토어 루미", status: "IN_PROGRESS", title: "봄 자켓 소재 정보 요청", orderId: 110, content: "봄 자켓 소재가 무엇인지, 세탁기 사용 가능한지 궁금합니다.", isSecret: false, createdAt: "2026-04-08 15:00", lastMessageAt: "2026-04-08 15:00", customerName: "서재철" },
  { id: 3, storeId: 2, storeName: "맛있는 빵집", status: "RESOLVED", title: "크루아상 유통기한 문의", orderId: 201, content: "크루아상 세트 유통기한이 어떻게 되나요?", isSecret: false, createdAt: "2026-03-08 09:00", lastMessageAt: "2026-03-08 11:30", customerName: "서재철" },
  { id: 4, storeId: 2, storeName: "맛있는 빵집", status: "RESOLVED", title: "티라미수 주문 수량 변경", orderId: 207, content: "티라미수 1개 추가 주문 가능할까요?", isSecret: false, createdAt: "2026-04-07 08:30", lastMessageAt: "2026-04-07 10:00", customerName: "서재철" },
  { id: 5, storeId: 3, storeName: "테크존 전자", status: "IN_PROGRESS", title: "모니터 데드픽셀 문의", orderId: 304, content: "모니터 우측 하단에 데드픽셀이 2개 보입니다. 교환 가능한가요?", isSecret: false, createdAt: "2026-03-28 09:00", lastMessageAt: "2026-03-28 09:00", customerName: "서재철" },
  { id: 6, storeId: 4, storeName: "그린라이프 마트", status: "RESOLVED", title: "대나무 칫솔 경도 문의", orderId: 401, content: "칫솔모가 부드러운 편인가요? 잇몸이 약해서요.", isSecret: false, createdAt: "2026-03-12 10:00", lastMessageAt: "2026-03-12 11:00", customerName: "서재철" },
  { id: 7, storeId: 4, storeName: "그린라이프 마트", status: "RESOLVED", title: "에코백 색상 교환", orderId: 404, content: "내추럴 색상을 주문했는데 차콜로 바꿀 수 있을까요?", isSecret: false, createdAt: "2026-04-05 11:00", lastMessageAt: "2026-04-05 14:00", customerName: "서재철" },
  { id: 8, storeId: 5, storeName: "북카페 서랍", status: "RESOLVED", title: "원두 분쇄도 문의", orderId: 501, content: "원두 구매 시 분쇄해서 보내주실 수 있나요? 핸드드립용이요.", isSecret: false, createdAt: "2026-03-15 09:00", lastMessageAt: "2026-03-15 10:30", customerName: "서재철" },
];

export const MOCK_INQUIRY_REPLIES_BY_POST_ID = {
  1: [{ id: 1, inquiryPostId: 1, authorType: "operator", content: "다음 주 화요일에 재입고 예정입니다! 입고 알림 등록해드릴까요?", createdAt: "2026-03-16 14:00" }],
  2: [],
  3: [{ id: 1, inquiryPostId: 3, authorType: "operator", content: "상온 보관 시 3일, 냉장 보관 시 7일입니다!", createdAt: "2026-03-08 11:30" }],
  4: [{ id: 1, inquiryPostId: 4, authorType: "operator", content: "이미 제조에 들어가서 추가 주문은 별도로 넣어주셔야 합니다. 죄송합니다!", createdAt: "2026-04-07 10:00" }],
  5: [],
  6: [{ id: 1, inquiryPostId: 6, authorType: "operator", content: "소프트 모입니다. 잇몸이 약하신 분도 편하게 사용 가능해요!", createdAt: "2026-03-12 11:00" }],
  7: [{ id: 1, inquiryPostId: 7, authorType: "operator", content: "아직 발송 전이라 변경 가능합니다. 차콜로 변경 처리해드렸습니다!", createdAt: "2026-04-05 14:00" }],
  8: [{ id: 1, inquiryPostId: 8, authorType: "operator", content: "네, 주문 시 요청사항에 '핸드드립용 분쇄'라고 적어주시면 맞춰 드립니다!", createdAt: "2026-03-15 10:30" }],
};
