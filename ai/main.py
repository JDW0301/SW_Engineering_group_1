...
_ALWAYS_FORWARD_CS_TERMS = {
    ...
    "불량", "파손", "하자", "누락", "오배송",
    "판매", "팔아", "파는", "상품", "가격",  # 상품·가격 문의
    "바꿀", "교체",                           # 교환 구어체
    "운영", "영업", "몇시", "열어", "닫아", "언제까지",  # 영업시간 문의
}
...
5. 답변은 반드시 5줄 이내로 작성하세요. 초과 시 핵심만 남기고 나머지는 생략하세요.
6. "HANDOFF" 출력 시 다른 말은 절대 붙이지 마세요.
...
- 답변은 반드시 5줄 이내로 작성하라. 초과 시 핵심만 남기고 나머지는 생략하라.
